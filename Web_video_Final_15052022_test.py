...
# Porta = 81 WebCam = 134 mic = 48 comandos = 309 voz = 205
...
porta = 'COM8' # linux ou mac em geral -> '/dev/ttyS0'
...
def falar():
    ...
    voz = 0  #3 IVONA 2 Ricardo - portugalski brazylijski
    ...
    try:
        ...
        try:
            ...
            if ("pesquise por" in text):
                ...
                textoRecebido ='Por favor aguarde, pesquisando por' + pesquisa     
                textoFalado ='Por favor aguarde, pesquisando por' + pesquisa
                falarTexto = True
